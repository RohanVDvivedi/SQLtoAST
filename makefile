...
PUBLIC_HEADERS:=${PROJECT_NAME}.h sql_expression.h sql_expression_eval.h sql_type.h sql_dql.h sql_dml.h sql_cte.h sql_ddl.h sql_tcl.h sql_logical_plan.h
...
CC:=gcc
# compiler flags
CFLAGS:=-Wall -O3 -flto -I${INC_DIR} -I${SRC_DIR}
