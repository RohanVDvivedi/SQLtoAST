...
bool_expr :
			...
			| value_expr IS bool_literal %prec IS_PREC										{$$.expr = new_binary_sql_expr(SQL_IS, $1.expr, $3.expr); $$.type = SQL_EXPR;}
			| value_expr IS L_NOT bool_literal %prec IS_PREC 								{$$.expr = new_unary_sql_expr(SQL_LOGNOT, new_binary_sql_expr(SQL_IS, $1.expr, $4.expr)); $$.type = SQL_EXPR;}
